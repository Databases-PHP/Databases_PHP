...
<html>
	...
	//view list of customer orders
        ...
        for ($i = 0; $i < $numRow; $i++) {
            ...
            //Find the status and time of the order from the CustomerOrder table
            $query = "select CO.orderStatus, CO.TimeStamp from CustomerOrder CO where CO.orderID = $orderID";
